...
<?php
if(isset($_POST['username']) && isset($_POST['db']) && isset($_POST['server'])) {
...
<div id="site">
	<div id="content">
		...
		<div class="chunk">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="chart">
				...
				<tbody>
					...
					<tr class="<?php echo ($php8_ok) ? 'enabled' : 'disabled'; ?>">
						<td>PHP</td>
						<td>8.0.0 or higher</td>
						<td><?php echo phpversion(); ?></td>
					</tr>
					<tr class="<?php echo ($mysqli_ok) ? 'enabled' : 'disabled'; ?>">
						<td>MySQLi Extension</td>
						<td>Enabled</td>
						<td><?php echo ($mysqli_ok) ? 'Enabled' : 'Disabled'; ?></td>
					</tr>
					<tr class="<?php echo ($db_conn=== true) ? 'enabled' : 'disabled'; ?>">
						<td>Database connection</td>
						<td>Success</td>
						<td><?php echo ($db_conn === true) ? 'Success' : 'Failed'; ?></td>
					</tr>
		...
		<div class="chunk">
			...
			<?php if ($php_ok && $mysqli_ok && $openssl_ok && $db_conn === true): ?>
